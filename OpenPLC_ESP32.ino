...
//const char *password = "casamarisa";
const char *ssid = "J5 Pro";
const char *password = "12345678";

/***************************************/


#define NODE_PIN_D0   25
#define NODE_PIN_D1   26
#define NODE_PIN_D2   27
#define NODE_PIN_D3   13
#define NODE_PIN_D4   34
#define NODE_PIN_D5   35
#define NODE_PIN_D6   32
#define NODE_PIN_D7   33
#define NODE_PIN_A8   36  //pino VP
#define A0            12
...
uint8_t pinMask_AIN[] = { NODE_PIN_A8 };
...
void updateIO()
{
    ...
    for (int i = 0; i < sizeof(pinMask_AIN); i++)
    {
        ...
        Serial.print("AI: "); 
        delay(100);
        Serial.println(analogRead(pinMask_AIN[i]));
    }
